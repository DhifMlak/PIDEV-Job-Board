...
namespace JobsForCoders.Controllers
{
    ...
    /*    public ActionResult Export(Report report)
        ...
        public Report GenerateDataReport(Report report)
        {
            ...
            {
                jobApplicationsQuery = jobApplicationsQuery.Where(a => a.Offre.Entreprise.Name.Contains(report.EmployerName));
            }
            if (report.Position != null)
            {
                jobApplicationsQuery = jobApplicationsQuery.Where(a => a.Offre.Position.Contains(report.Position));
            }
